...
public class User {
	...
	public User(int userId, String userName, String userEmail, String mobileNum) {
		super();
		this.userId = userId;
		this.userName = userName;
		this.userEmail = userEmail;
	...
	public User(int userId, String userName, String userEmail, String mobileNum, String dob) {
		super();
		this.userId = userId;
		this.userName = userName;
		this.userEmail = userEmail;
	...
	public User(int userId, String userName, String userEmail, String mobileNum, String dob, String userGender) {
		super();
		this.userId = userId;
		this.userName = userName;
		this.userEmail = userEmail;
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", userEmail=" + userEmail + ", mobileNum="
				+ mobileNum + ", dob=" + dob + ", userGender=" + userGender + ", userPwd=" + userPwd + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
